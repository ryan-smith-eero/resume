...
\section{About Me}
   ...
   \small{I am passionate about learning and developing new technologies as well as tinkering with complex systems---especially genomes and software. After 7 years of genetics and bioinformatics training in academia, I am seeking experience in the biotechnology industry.}
   
  	\resumeSubHeadingListStart
   
   \resumeItem{Relevant Interests}
   {Bioinformatics, genetics/genomics, DNA editing, genome engineering, object-oriented and functional programming, distributed computing, data visualization.}
...
\section{Programming Skills}
    \resumeSubHeadingListStart
        ...
        {Linux/Unix, OSX, git, Docker, BWA, GATK, IBM Platform LSF, Oracle Grid Engine}
