...
\section{About Me}
   ...
   {DevOps, continuous integration, distributed/cloud computing, containers, automation, object-oriented and functional programming, data enginering, bioinformatics, genetics/genomics, }
