...
\section{About Me}
   ...
   {DevOps, continuous integration, distributed/cloud computing\colon{} AWS \& GCP, containers, automation, object-oriented and functional programming, data enginering, bioinformatics}
